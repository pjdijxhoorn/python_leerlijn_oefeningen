...
def les2():
    ...
    Stap1:  maak twee variabele maximaal en mininmaal.
    ...
    Stap2:  Maak nog twee varaibele randomNumber1 en randomNumber2 en vul deze met random.randint() 
            met de minimaal en maximaal als bereik. hierdoor krijge je een getal tussen minimaal en maximaal.
